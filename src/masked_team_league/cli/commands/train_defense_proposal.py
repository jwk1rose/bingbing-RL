...
from masked_team_league.generation.proposal_networks import DefenseRosterGenerationNetwork, ProposalNetworkConfig
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train DefenseRosterGenerationNetwork from defense teacher JSONL artifacts.")
