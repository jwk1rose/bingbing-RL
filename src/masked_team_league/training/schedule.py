...
from ..data_engineering.run_metadata import RunArtifactRef, RunMetadataManifest, hash_generation_config, write_run_metadata_manifest
...
def _cli_command(module: str) -> list[str]:
    """生成可在开发环境和安装环境中稳定运行的 package CLI 命令。"""

    return [sys.executable, "-m", f"masked_team_league.cli.commands.{module}"]
...
def build_v4_training_schedule(
    *,
    ...
    if single_team_train_jsonl is not None:
        ...
        split_command = [
            *_cli_command("build_split_manifest"),
            "--split",
            f"train={train}",
            "--dataset-id",
        ...
        train_command = [
            *_cli_command("train_single_team_model"),
            "--samples-jsonl",
            str(train),
            "--out-model",
            str(value_model),
    ...
    if round_belief_dirs:
        ...
        command = [
            *_cli_command("build_belief_ranker_dataset"),
            "--out-dir",
            str(dataset_dir),
            "--holdout-fraction",
    ...
    if belief_train_jsonl is not None:
        ...
        train_command = [
            *_cli_command("train_belief_ranker"),
            "--samples-jsonl",
            str(train),
            "--out-checkpoint",
            str(checkpoint),
    ...
    if attack_teacher_jsonl is not None:
        jobs.extend(
            _proposal_jobs(
                ...
                train_module="train_attack_proposal",
    ...
    if defense_teacher_jsonl is not None:
        jobs.extend(
            _proposal_jobs(
                ...
                train_module="train_defense_proposal",
    ...
    if mask_teacher_jsonl is not None:
        ...
        train_command = [
            *_cli_command("train_mask_selection"),
            "--teacher-jsonl",
    ...
    if attack_teacher_jsonl is not None or exploiter_training_root is not None:
        ...
        command = [
            *_cli_command("report_exploiter_effectiveness"),
            "--out-report",
            str(report),
            "--min-target-coverage",
    ...
    if defense_teacher_jsonl is not None or defense_anti_meta_training_root is not None:
        ...
        command = [
            *_cli_command("report_defense_anti_meta_effectiveness"),
            "--out-report",
            str(report),
    ...
    if learned_exploiter_selfplay_root is not None:
        ...
        command = [
            *_cli_command("report_learned_exploiter_validation"),
            "--selfplay-root",
            str(selfplay_root),
            "--out-report",
            str(report),
    ...
    if attack_failure_round_paths or attack_failure_output_paths:
        ...
        command = [
            *_cli_command("report_attack_oracle_failure_validation"),
            "--out-report",
            str(report),
    ...
    if active_query_round_paths:
        ...
        command = [
            *_cli_command("report_active_query_feedback"),
            "--out-report",
            str(report),
    ...
    if active_real_dispatch_validation_paths:
        ...
        command = [
            *_cli_command("report_active_real_query_dispatch_validation"),
            "--out-report",
            str(report),
            "--min-reports",
    ...
    if data_engineering_round_paths:
        ...
        command = [
            *_cli_command("report_data_engineering_validation"),
            "--out-report",
            str(report),
    ...
    if underdog_residual_round_paths:
        ...
        command = [
            *_cli_command("report_underdog_residual_validation"),
            "--out-report",
            str(report),
    ...
    if league_health_round_paths:
        ...
        command = [
            *_cli_command("report_league_selfplay_health"),
            "--out-report",
            str(report),
            "--min-attack-pool",
    ...
    if mask_explanation_round_paths:
        ...
        command = [
            *_cli_command("report_mask_explanation_validation"),
            "--out-report",
            str(report),
    ...
    if belief_real_round_paths:
        ...
        command = [
            *_cli_command("report_belief_real_distribution_validation"),
            "--out-report",
            str(report),
            "--min-real-coverage",
    ...
    if real_round_paths or active_real_feedback_paths:
        ...
        command = _cli_command("ingest_real_calibration")
    ...
    if build_real_calibration_samples_jsonl is not None:
        ...
        command = [
            *_cli_command("build_real_calibration_samples"),
            "--out-jsonl",
            str(sample_jsonl),
            "--out-report",
            str(sample_report),
    ...
    if real_calibration_validation_sample_paths:
        ...
        command = [
            *_cli_command("report_real_calibration_validation"),
            "--calibration-json",
            str(model_json),
            "--out-report",
            str(report),
    ...
    if v4_conformance_paths:
        ...
        command = [
            *_cli_command("report_v4_conformance_validation"),
            "--out-report",
            str(report),
        ]
    ...
    if production_readiness_paths:
        ...
        command = [
            *_cli_command("report_production_readiness"),
            "--out-report",
            str(report),
...
def _selection_job(
    ...
    return ScheduledTrainingJob(
        ...
        command=(
            *_cli_command("select_model_checkpoint"),
            "--registry",
            str(registry),
            "--metric",
            metric,
